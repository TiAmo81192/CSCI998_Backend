...
public class AppAgent extends Agent{
    ...
    public void setup() {
        try {
            ...
            org.fog.mas.MainClass.fogDevices.add(device);
            ...
            Map m = new Map(appId, org.fog.mas.MainClass.fogDevices.get(1).getName(), application);

            org.fog.mas.MainClass.maps.add(m);
